...
public class IConversationStateChangePropertyDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IConversationStateChangePropertyDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(final com.wilutions.mslib.uccollaborationlib.ConversationStateChangeProperty _modalityType) throws ComException {
  ...
  @DeclDISPID(1610743812)  public Boolean TryGetValue(final com.wilutions.mslib.uccollaborationlib.ConversationStateChangeProperty _propertyType, final ByRef<Object> _itemValue) throws ComException {
  ...
  @DeclDISPID(1610743813)  public com.wilutions.mslib.uccollaborationlib.ConversationStateChangeProperty GetKeyAt(final Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743815)  public Boolean ContainsKey(final com.wilutions.mslib.uccollaborationlib.ConversationStateChangeProperty _propertyType) throws ComException {
    assert(_propertyType != null);
