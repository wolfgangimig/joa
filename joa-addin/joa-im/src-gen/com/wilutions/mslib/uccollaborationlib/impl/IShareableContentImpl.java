...
public class IShareableContentImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IShareableContent {
  ...
  @DeclDISPID(1610743821)  public void SaveAnnotation(final String _fileName, final com.wilutions.mslib.uccollaborationlib.ContentSavingFileType _fileType) throws ComException {
  ...
  @DeclDISPID(1610743822)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation DownloadFile(final String _localPath, final Object _callback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743823)  public Boolean CanInvoke(final com.wilutions.mslib.uccollaborationlib.ShareableContentAction _action, final ByRef<HRESULT> _hrReason) throws ComException {
    assert(_action != null);
