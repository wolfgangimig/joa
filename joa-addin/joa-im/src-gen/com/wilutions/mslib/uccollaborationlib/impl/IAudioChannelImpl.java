...
public class IAudioChannelImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IAudioChannel {
  ...
  @DeclDISPID(1610809344)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation SendDtmf(final String _tones, final Object _modalityCallback, final Object _state) throws ComException {
    assert(_tones != null);
