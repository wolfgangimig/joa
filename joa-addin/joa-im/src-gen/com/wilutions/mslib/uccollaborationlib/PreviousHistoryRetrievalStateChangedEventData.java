 ...
 * PreviousHistoryRetrievalStateChangedEventData Class 
 */
...
public class PreviousHistoryRetrievalStateChangedEventData extends Dispatch {
  ...
  protected PreviousHistoryRetrievalStateChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[PreviousHistoryRetrievalStateChangedEventData" + super.toString() + "]";
  }
}
