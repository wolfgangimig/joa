 ...
 * Represents data for the ContactSettingChanged event. 
 */
...
public class ContactSettingChangedEventData extends Dispatch {
  ...
  protected ContactSettingChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ContactSettingChangedEventData" + super.toString() + "]";
  }
}
