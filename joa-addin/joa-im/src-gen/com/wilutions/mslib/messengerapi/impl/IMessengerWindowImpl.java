...
@CoClass(guid="{16277DA3-5EB5-93C4-2FDF-642200735102}")
public class IMessengerWindowImpl extends Dispatch implements com.wilutions.mslib.messengerapi.IMessengerWindow {
  ...
  public IMessengerWindowImpl(String progId) throws ComException {
    super(progId, "{D6B0E4C8-FAD6-4885-B271-0DC5A584ADF8}");
  }
  protected IMessengerWindowImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[IMessengerWindowImpl" + super.toString() + "]";
  }
}
