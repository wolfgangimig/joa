...
public class OlObjectClass implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & 156) != 0) sbuf.append("|olNavigationModules");
      if ((value & 64) != 0) sbuf.append("|olOutlookBarStorage");
      if ((value & 8) != 0) sbuf.append("|olAddressEntry");
      if ((value & 101) != 0) sbuf.append("|olReminder");
      if ((value & 37) != 0) sbuf.append("|olFormDescription");
      if ((value & 0) != 0) sbuf.append("|olApplication");
      if ((value & 100) != 0) sbuf.append("|olReminders");
      if ((value & 36) != 0) sbuf.append("|olPages");
      if ((value & 1) != 0) sbuf.append("|olNamespace");
      if ((value & 80) != 0) sbuf.append("|olView");
      if ((value & 103) != 0) sbuf.append("|olConflicts");
      if ((value & 35) != 0) sbuf.append("|olInspector");
      if ((value & 2) != 0) sbuf.append("|olFolder");
      if ((value & 167) != 0) sbuf.append("|olNavigationFolder");
      if ((value & 15) != 0) sbuf.append("|olFolders");
      if ((value & 68) != 0) sbuf.append("|olOutlookBarShortcut");
      if ((value & 105) != 0) sbuf.append("|olAccount");
      if ((value & 33) != 0) sbuf.append("|olActions");
      if ((value & 4) != 0) sbuf.append("|olRecipient");
      if ((value & 69) != 0) sbuf.append("|olDistributionList");
      if ((value & 104) != 0) sbuf.append("|olSharing");
      if ((value & 32) != 0) sbuf.append("|olAction");
      if ((value & 5) != 0) sbuf.append("|olAttachment");
      if ((value & 164) != 0) sbuf.append("|olNavigationGroups");
      if ((value & 16) != 0) sbuf.append("|olItems");
      if ((value & 106) != 0) sbuf.append("|olAccounts");
      if ((value & 30) != 0) sbuf.append("|olException");
      if ((value & 7) != 0) sbuf.append("|olAddressList");
      if ((value & 165) != 0) sbuf.append("|olNavigationGroup");
      if ((value & 17) != 0) sbuf.append("|olRecipients");
      if ((value & 54) != 0) sbuf.append("|olMeetingCancellation");
      if ((value & 113) != 0) sbuf.append("|olStorageItem");
      if ((value & 21) != 0) sbuf.append("|olAddressEntries");
      if ((value & 18) != 0) sbuf.append("|olAttachments");
      if ((value & 55) != 0) sbuf.append("|olMeetingResponseNegative");
      if ((value & 112) != 0) sbuf.append("|olPropertyAccessor");
      if ((value & 20) != 0) sbuf.append("|olAddressLists");
      if ((value & 53) != 0) sbuf.append("|olMeetingRequest");
      if ((value & 114) != 0) sbuf.append("|olRules");
      if ((value & 26) != 0) sbuf.append("|olAppointment");
      if ((value & 56) != 0) sbuf.append("|olMeetingResponsePositive");
      if ((value & 57) != 0) sbuf.append("|olMeetingResponseTentative");
      if ((value & 28) != 0) sbuf.append("|olRecurrencePattern");
      if ((value & 29) != 0) sbuf.append("|olExceptions");
      if ((value & 102) != 0) sbuf.append("|olConflict");
      if ((value & 34) != 0) sbuf.append("|olExplorer");
      if ((value & 151) != 0) sbuf.append("|olCalendarSharing");
      if ((value & 63) != 0) sbuf.append("|olOutlookBarPane");
      if ((value & 38) != 0) sbuf.append("|olUserProperties");
      if ((value & 150) != 0) sbuf.append("|olColumns");
      if ((value & 62) != 0) sbuf.append("|olPanes");
      if ((value & 39) != 0) sbuf.append("|olUserProperty");
      if ((value & 40) != 0) sbuf.append("|olContact");
      if ((value & 41) != 0) sbuf.append("|olDocument");
      if ((value & 42) != 0) sbuf.append("|olJournal");
      if ((value & 43) != 0) sbuf.append("|olMail");
      if ((value & 44) != 0) sbuf.append("|olNote");
      if ((value & 45) != 0) sbuf.append("|olPost");
      if ((value & 46) != 0) sbuf.append("|olReport");
      if ((value & 47) != 0) sbuf.append("|olRemote");
      if ((value & 48) != 0) sbuf.append("|olTask");
      if ((value & 49) != 0) sbuf.append("|olTaskRequest");
      if ((value & 50) != 0) sbuf.append("|olTaskRequestUpdate");
      if ((value & 51) != 0) sbuf.append("|olTaskRequestAccept");
      if ((value & 52) != 0) sbuf.append("|olTaskRequestDecline");
      if ((value & 152) != 0) sbuf.append("|olCategory");
      if ((value & 60) != 0) sbuf.append("|olExplorers");
      if ((value & 153) != 0) sbuf.append("|olCategories");
      if ((value & 61) != 0) sbuf.append("|olInspectors");
      if ((value & 157) != 0) sbuf.append("|olNavigationModule");
      if ((value & 65) != 0) sbuf.append("|olOutlookBarGroups");
      if ((value & 154) != 0) sbuf.append("|olColumn");
      if ((value & 66) != 0) sbuf.append("|olOutlookBarGroup");
      if ((value & 155) != 0) sbuf.append("|olClassNavigationPane");
      if ((value & 67) != 0) sbuf.append("|olOutlookBarShortcuts");
      if ((value & 70) != 0) sbuf.append("|olPropertyPageSite");
      if ((value & 71) != 0) sbuf.append("|olPropertyPages");
      if ((value & 72) != 0) sbuf.append("|olSyncObject");
      if ((value & 73) != 0) sbuf.append("|olSyncObjects");
      if ((value & 74) != 0) sbuf.append("|olSelection");
      if ((value & 75) != 0) sbuf.append("|olLink");
      if ((value & 148) != 0) sbuf.append("|olAutoFormatRules");
      if ((value & 76) != 0) sbuf.append("|olLinks");
      if ((value & 149) != 0) sbuf.append("|olColumnFormat");
      if ((value & 77) != 0) sbuf.append("|olSearch");
      if ((value & 146) != 0) sbuf.append("|olViewFont");
      if ((value & 78) != 0) sbuf.append("|olResults");
      if ((value & 147) != 0) sbuf.append("|olAutoFormatRule");
      if ((value & 79) != 0) sbuf.append("|olViews");
      if ((value & 98) != 0) sbuf.append("|olItemProperties");
      if ((value & 99) != 0) sbuf.append("|olItemProperty");
      if ((value & 107) != 0) sbuf.append("|olStore");
      if ((value & 108) != 0) sbuf.append("|olStores");
      if ((value & 109) != 0) sbuf.append("|olSelectNamesDialog");
      if ((value & 110) != 0) sbuf.append("|olExchangeUser");
      if ((value & 111) != 0) sbuf.append("|olExchangeDistributionList");
      if ((value & 115) != 0) sbuf.append("|olRule");
      if ((value & 116) != 0) sbuf.append("|olRuleActions");
      if ((value & 117) != 0) sbuf.append("|olRuleAction");
      if ((value & 118) != 0) sbuf.append("|olMoveOrCopyRuleAction");
      if ((value & 119) != 0) sbuf.append("|olSendRuleAction");
      if ((value & 120) != 0) sbuf.append("|olTable");
      if ((value & 121) != 0) sbuf.append("|olRow");
      if ((value & 122) != 0) sbuf.append("|olAssignToCategoryRuleAction");
      if ((value & 123) != 0) sbuf.append("|olPlaySoundRuleAction");
      if ((value & 124) != 0) sbuf.append("|olMarkAsTaskRuleAction");
      if ((value & 125) != 0) sbuf.append("|olNewItemAlertRuleAction");
      if ((value & 126) != 0) sbuf.append("|olRuleConditions");
      if ((value & 127) != 0) sbuf.append("|olRuleCondition");
      if ((value & 128) != 0) sbuf.append("|olImportanceRuleCondition");
      if ((value & 129) != 0) sbuf.append("|olFormRegion");
      if ((value & 130) != 0) sbuf.append("|olCategoryRuleCondition");
      if ((value & 131) != 0) sbuf.append("|olFormNameRuleCondition");
      if ((value & 132) != 0) sbuf.append("|olFromRuleCondition");
      if ((value & 133) != 0) sbuf.append("|olSenderInAddressListRuleCondition");
      if ((value & 134) != 0) sbuf.append("|olTextRuleCondition");
      if ((value & 135) != 0) sbuf.append("|olAccountRuleCondition");
      if ((value & 136) != 0) sbuf.append("|olClassTableView");
      if ((value & 137) != 0) sbuf.append("|olClassIconView");
      if ((value & 138) != 0) sbuf.append("|olClassCardView");
      if ((value & 139) != 0) sbuf.append("|olClassCalendarView");
      if ((value & 140) != 0) sbuf.append("|olClassTimeLineView");
      if ((value & 141) != 0) sbuf.append("|olViewFields");
      if ((value & 142) != 0) sbuf.append("|olViewField");
      if ((value & 144) != 0) sbuf.append("|olOrderField");
      if ((value & 145) != 0) sbuf.append("|olOrderFields");
      if ((value & 158) != 0) sbuf.append("|olMailModule");
      if ((value & 159) != 0) sbuf.append("|olCalendarModule");
      if ((value & 160) != 0) sbuf.append("|olContactsModule");
      if ((value & 161) != 0) sbuf.append("|olTasksModule");
      if ((value & 162) != 0) sbuf.append("|olJournalModule");
      if ((value & 163) != 0) sbuf.append("|olNotesModule");
      if ((value & 166) != 0) sbuf.append("|olNavigationFolders");
      if ((value & 168) != 0) sbuf.append("|olClassBusinessCardView");
      if ((value & 169) != 0) sbuf.append("|olAttachmentSelection");
      if ((value & 170) != 0) sbuf.append("|olAddressRuleCondition");
      if ((value & 171) != 0) sbuf.append("|olUserDefinedProperty");
      if ((value & 172) != 0) sbuf.append("|olUserDefinedProperties");
      if ((value & 173) != 0) sbuf.append("|olFromRssFeedRuleCondition");
      if ((value & 174) != 0) sbuf.append("|olClassTimeZone");
      if ((value & 175) != 0) sbuf.append("|olClassTimeZones");
      if ((value & 176) != 0) sbuf.append("|olMobile");
      if ((value & 177) != 0) sbuf.append("|olSolutionsModule");
      if ((value & 178) != 0) sbuf.append("|olConversation");
      if ((value & 179) != 0) sbuf.append("|olSimpleItems");
      if ((value & 180) != 0) sbuf.append("|olOutspace");
      if ((value & 181) != 0) sbuf.append("|olMeetingForwardNotification");
      if ((value & 182) != 0) sbuf.append("|olConversationHeader");
      if ((value & 183) != 0) sbuf.append("|olClassPeopleView");
