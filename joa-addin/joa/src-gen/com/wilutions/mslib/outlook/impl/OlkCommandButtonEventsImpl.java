...
@CoClass(guid="{C091EB8B-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkCommandButtonEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkCommandButtonEvents {
  ...
  public OlkCommandButtonEventsImpl(String progId) throws ComException {
    super(progId, "{000672E0-0000-0000-C000-000000000046}");
  }
  protected OlkCommandButtonEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkCommandButtonEventsImpl" + super.toString() + "]";
  }
}
