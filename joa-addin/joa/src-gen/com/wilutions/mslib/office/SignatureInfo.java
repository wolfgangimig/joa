...
public interface SignatureInfo extends IDispatch {
  ...
  @DeclDISPID(6)  public Object GetSignatureDetail(final SignatureDetail sigdet) throws ComException;
  @DeclDISPID(7)  public Object GetCertificateDetail(final CertificateDetail certdet) throws ComException;
