...
public class XlConstants implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & -4105) != 0) sbuf.append("|xlAutomatic");
      if ((value & -4142) != 0) sbuf.append("|xlNone");
      if ((value & 17) != 0) sbuf.append("|xlGray16");
      if ((value & -4111) != 0) sbuf.append("|xlCombination");
      if ((value & -4103) != 0) sbuf.append("|xl3DSurface");
      if ((value & -4099) != 0) sbuf.append("|xl3DBar");
      if ((value & 3) != 0) sbuf.append("|xlColumn");
      if ((value & 12) != 0) sbuf.append("|xlLightVertical");
      if ((value & -4114) != 0) sbuf.append("|xlCustom");
      if ((value & 2) != 0) sbuf.append("|xlBar");
      if ((value & -1) != 0) sbuf.append("|xlDefaultAutoFormat");
      if ((value & 0) != 0) sbuf.append("|xlAbove");
      if ((value & 1) != 0) sbuf.append("|xlBelow");
      if ((value & -4107) != 0) sbuf.append("|xlBottom");
      if ((value & -4108) != 0) sbuf.append("|xlCenter");
      if ((value & -4152) != 0) sbuf.append("|xlRight");
      if ((value & 9) != 0) sbuf.append("|xlChecker");
      if ((value & 8) != 0) sbuf.append("|xlCircle");
      if ((value & 16) != 0) sbuf.append("|xlCrissCross");
      if ((value & -4126) != 0) sbuf.append("|xlGray75");
      if ((value & 4) != 0) sbuf.append("|xlCross");
      if ((value & 11) != 0) sbuf.append("|xlLightHorizontal");
      if ((value & -4117) != 0) sbuf.append("|xlDistributed");
      if ((value & -4127) != 0) sbuf.append("|xlHigh");
      if ((value & 5) != 0) sbuf.append("|xlFill");
      if ((value & -4124) != 0) sbuf.append("|xlGray25");
      if ((value & -4125) != 0) sbuf.append("|xlGray50");
      if ((value & 18) != 0) sbuf.append("|xlGray8");
      if ((value & 15) != 0) sbuf.append("|xlGrid");
      if ((value & -4130) != 0) sbuf.append("|xlJustify");
      if ((value & -4131) != 0) sbuf.append("|xlLeft");
      if ((value & 13) != 0) sbuf.append("|xlLightDown");
      if ((value & 14) != 0) sbuf.append("|xlLightUp");
      if ((value & -4134) != 0) sbuf.append("|xlLow");
      if ((value & 10) != 0) sbuf.append("|xlSemiGray75");
      if ((value & -4160) != 0) sbuf.append("|xlTop");
