...
public class MessageBox {
	...
	public static class Builder {
		...
		public Builder owner(Object v) {
			assert (v instanceof Dispatch) || (v instanceof ModalDialogSwing);
			if (v instanceof ModalDialogSwing) {
				_owner = v;
			} else {
		...
		public Builder button(int id, JButton button) {
...
//		button.setDefaultButton(true);
	...
	protected static class DialogBox extends ModalDialogSwing<Integer> {
