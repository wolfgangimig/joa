 ...
 * PreviousConversationsManagerNewItemCountChangedEventData Class 
 */
...
public class PreviousConversationsManagerNewItemCountChangedEventData extends Dispatch {
  ...
  protected PreviousConversationsManagerNewItemCountChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[PreviousConversationsManagerNewItemCountChangedEventData" + super.toString() + "]";
  }
}
