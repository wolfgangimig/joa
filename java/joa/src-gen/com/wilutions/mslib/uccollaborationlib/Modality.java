...
/**
 * Modality.
 * Modality is the base class for any modality, including InstantMessageModality and 
 * AVModality. 
 */
@CoClass(guid="{61419951-5D5A-4DA3-BE6A-076F9645229E}")
public class Modality extends Dispatch implements IModality {
  ...
  public Modality() throws ComException {
    super("{61419951-5D5A-4DA3-BE6A-076F9645229E}", "{D4B240B9-059B-4D13-8997-31B282B3BD43}");
  }
  protected Modality(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[Modality" + super.toString() + "]";
  }
}
