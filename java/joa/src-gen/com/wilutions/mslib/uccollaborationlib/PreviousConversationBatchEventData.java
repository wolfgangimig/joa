 ...
 * PreviousConversationBatchEventData Class 
 */
...
public class PreviousConversationBatchEventData extends Dispatch {
  ...
  protected PreviousConversationBatchEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[PreviousConversationBatchEventData" + super.toString() + "]";
  }
}
