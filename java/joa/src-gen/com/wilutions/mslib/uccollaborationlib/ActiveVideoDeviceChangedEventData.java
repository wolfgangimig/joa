...
/**
 * ActiveVideoDeviceChangedEventData.
 * ActiveVideoDeviceChangedEventData Class 
 */
...
public class ActiveVideoDeviceChangedEventData extends Dispatch {
  ...
  protected ActiveVideoDeviceChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ActiveVideoDeviceChangedEventData" + super.toString() + "]";
  }
}
