...
public class IApplicationSharingModalityImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IApplicationSharingModality {
  ...
  @DeclDISPID(1610809346)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation ShareResources(com.wilutions.mslib.uccollaborationlib.ISharingResourceList _resources, Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809347)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation ShareDesktop(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809348)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation ShareMonitorByRect(Integer Left, Integer Top, Integer right, Integer bottom, Object _modalityCallback, Object _state) throws ComException {
    assert(Left != null);
    assert(Top != null);
    assert(right != null);
    assert(bottom != null);
  ...
  @DeclDISPID(1610809352)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation RequestControl(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809353)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation ReleaseControl(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809354)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation GrantControl(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809355)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation RevokeControl(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809356)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation AcceptControlRequest(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809357)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation DeclineControlRequest(Object _modalityCallback, Object _state) throws ComException {
    assert(_modalityCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610809358)  public com.wilutions.mslib.uccollaborationlib.CanShareDetail CanShare(com.wilutions.mslib.uccollaborationlib.SharingResourceType _resourceType) throws ComException {
  ...
  @DeclDISPID(1610809360)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation ShareMonitor(Integer _monitorId, Object _modalityCallback, Object _state) throws ComException {
