...
public class IClientSettingsImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IClientSettings {
  @DeclDISPID(0)  public Object getItem(com.wilutions.mslib.uccollaborationlib.ClientSettingsType _settingType) throws ComException {
    assert(_settingType != null);
    final Object obj = this._dispatchCall(0,"Item", DISPATCH_PROPERTYGET,null,_settingType.value);
    if (obj == null) return null;
    return (Object)obj;
  }
  @DeclDISPID(0)  public void setItem(com.wilutions.mslib.uccollaborationlib.ClientSettingsType _settingType, Object value2) throws ComException {
    assert(value2 != null);
    assert(_settingType != null);
    this._dispatchCall(0,"Item", DISPATCH_PROPERTYPUT,value2,_settingType.value);
  }
  @DeclDISPID(1610743810)  public Boolean CanSetValue(com.wilutions.mslib.uccollaborationlib.ClientSettingsType _settingType) throws ComException {
    assert(_settingType != null);
