...
public class IContactImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IContact {
  ...
  @DeclDISPID(1610743809)  public Object GetContactInformation(com.wilutions.mslib.uccollaborationlib.ContactInformationType _contactInformationType) throws ComException {
  ...
  @DeclDISPID(1610743810)  public com.wilutions.mslib.uccollaborationlib.IContactInformationDictionary BatchGetContactInformation(com.wilutions.mslib.uccollaborationlib.ContactInformationType[] _contactInformationTypes) throws ComException {
    ...
    return disp.uncheckedAs(com.wilutions.mslib.uccollaborationlib.impl.IContactInformationDictionaryImpl.class);
  }
  @DeclDISPID(1610743811)  public com.wilutions.mslib.uccollaborationlib.IContactSettingDictionary getSettings() throws ComException {
    ...
    if (obj == null) return null;
    final Dispatch disp = (Dispatch)obj;
    return disp.uncheckedAs(com.wilutions.mslib.uccollaborationlib.impl.IContactSettingDictionaryImpl.class);
  }
  @DeclDISPID(1610743812)  public Boolean CanStart(com.wilutions.mslib.uccollaborationlib.ModalityTypes _modalityTypes) throws ComException {
  ...
  @DeclDISPID(1610743813)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation ChangeSetting(com.wilutions.mslib.uccollaborationlib.ContactSetting _contactSettingType, Object _contactSettingValue, Object _contactCallback, Object _state) throws ComException {
  ...
  @DeclDISPID(1610743814)  public Boolean CanChangeSetting(com.wilutions.mslib.uccollaborationlib.ContactSetting _contactSetting) throws ComException {
  ...
  @DeclDISPID(1610743817)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation MoveToGroup(com.wilutions.mslib.uccollaborationlib.IGroup _targetGroup, com.wilutions.mslib.uccollaborationlib.IGroup _sourceGroup, Object _contactCallback, Object _state) throws ComException {
    assert(_contactCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610743818)  public Boolean CanMoveToGroup(com.wilutions.mslib.uccollaborationlib.IGroup _targetGroup, com.wilutions.mslib.uccollaborationlib.IGroup _sourceGroup) throws ComException {
  ...
  @DeclDISPID(1610743819)  public com.wilutions.mslib.uccollaborationlib.IContactEndpoint CreateContactEndpoint(String _telephoneUri) throws ComException {
  ...
  @DeclDISPID(1610743821)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation GetOrganizationInformation(com.wilutions.mslib.uccollaborationlib.OrganizationStructureTypes _orgInfoTypes, Object _contactCallback, Object _state) throws ComException {
  ...
  @DeclDISPID(1610743822)  public com.wilutions.mslib.uccollaborationlib.IContactInformationDictionary GetMultipleContactInformation(com.wilutions.mslib.uccollaborationlib.ContactInformationType[] _contactInformationTypes) throws ComException {
    assert(_contactInformationTypes != null);
