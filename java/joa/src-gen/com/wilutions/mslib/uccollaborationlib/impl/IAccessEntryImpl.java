...
public class IAccessEntryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IAccessEntry {
  ...
  @DeclDISPID(1610743810)  public com.wilutions.mslib.uccollaborationlib.IAccessPermission getPermission() throws ComException {
    ...
    return disp.uncheckedAs(com.wilutions.mslib.uccollaborationlib.impl.IAccessPermissionImpl.class);
  }
  @DeclDISPID(1610743811)  public void SetPermission(com.wilutions.mslib.uccollaborationlib.IAccessPermission _permission) throws ComException {
  ...
  @DeclDISPID(1610743813)  public Boolean CanSetPermission(com.wilutions.mslib.uccollaborationlib.IAccessPermission _permission) throws ComException {
