...
public class IContactEndpointCollectionImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IContactEndpointCollection {
  ...
  @DeclDISPID(1610743809)  public void Add(com.wilutions.mslib.uccollaborationlib.IContactEndpoint _endpoint) throws ComException {
  ...
  @DeclDISPID(0)  public com.wilutions.mslib.uccollaborationlib.IContactEndpoint getItem(Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(0)  public void setItem(Integer _index, com.wilutions.mslib.uccollaborationlib.IContactEndpoint value2) throws ComException {
    assert(_index != null);
    this._dispatchCall(0,"Item", DISPATCH_PROPERTYPUT,(value2!=null?value2:Dispatch.NULL),_index);
  }
  @DeclDISPID(1610743815)  public void AddByUri(com.wilutions.mslib.uccollaborationlib.ContactEndpointType _endpointType, String _endpointUri) throws ComException {
  ...
  @DeclDISPID(1610743816)  public Integer IndexOf(com.wilutions.mslib.uccollaborationlib.IContactEndpoint _contactEndpoint) throws ComException {
