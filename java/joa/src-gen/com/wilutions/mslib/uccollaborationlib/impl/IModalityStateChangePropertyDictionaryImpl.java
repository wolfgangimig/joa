...
public class IModalityStateChangePropertyDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IModalityStateChangePropertyDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(com.wilutions.mslib.uccollaborationlib.ModalityStateChangeProperty _modalityType) throws ComException {
  ...
  @DeclDISPID(1610743812)  public Boolean TryGetValue(com.wilutions.mslib.uccollaborationlib.ModalityStateChangeProperty _modalityType, ByRef<Object> _itemValue) throws ComException {
    assert(_modalityType != null);
  ...
  @DeclDISPID(1610743813)  public com.wilutions.mslib.uccollaborationlib.ModalityStateChangeProperty GetKeyAt(Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743815)  public Boolean ContainsKey(com.wilutions.mslib.uccollaborationlib.ModalityStateChangeProperty _modalityType) throws ComException {
    assert(_modalityType != null);
