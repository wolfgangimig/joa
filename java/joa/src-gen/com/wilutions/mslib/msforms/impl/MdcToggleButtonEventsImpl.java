...
@CoClass(guid="{4B458409-4821-CA8F-03A3-694DA597FE09}")
public class MdcToggleButtonEventsImpl extends Dispatch implements com.wilutions.mslib.msforms.MdcToggleButtonEvents {
  ...
  public MdcToggleButtonEventsImpl(String progId) throws ComException {
    super(progId, "{8BD21D62-EC42-11CE-9E0D-00AA006002F3}");
  }
  protected MdcToggleButtonEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[MdcToggleButtonEventsImpl" + super.toString() + "]";
  }
}
