...
public class IFontImpl extends Dispatch implements com.wilutions.mslib.msforms.IFont {
  ...
  @DeclDISPID(1610678289)  public void Clone(ByRef<com.wilutions.mslib.msforms.IFont> lplpfont) throws ComException {
    assert(lplpfont != null);
    this._dispatchCall(1610678289,"Clone", DISPATCH_METHOD,null,lplpfont);
  }
  @DeclDISPID(1610678290)  public void IsEqual(com.wilutions.mslib.msforms.IFont lpFontOther) throws ComException {
  ...
  @DeclDISPID(1610678292)  public void AddRefHfont(com.wilutions.mslib.msforms.OLE_HANDLE hFont) throws ComException {
    assert(hFont != null);
    this._dispatchCall(1610678292,"AddRefHfont", DISPATCH_METHOD,null,hFont.getValue());
  }
  @DeclDISPID(1610678293)  public void ReleaseHfont(com.wilutions.mslib.msforms.OLE_HANDLE hFont) throws ComException {
    assert(hFont != null);
