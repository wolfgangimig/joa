 ...
 * 
 */
@CoClass(guid="{6C177EBD-C42D-4728-A04B-4131892EDBF6}")
public class ComboBox2 extends Dispatch implements IMdcCombo {
  ...
  public ComboBox2() throws ComException {
    super("{6C177EBD-C42D-4728-A04B-4131892EDBF6}", "{8BD21D33-EC42-11CE-9E0D-00AA006002F3}");
  }
  protected ComboBox2(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ComboBox2" + super.toString() + "]";
  }
}
