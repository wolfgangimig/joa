 ...
 * 
 */
@CoClass(guid="{DD4CB8C5-F540-47FF-84D7-67390D2743CA}")
public class TextBox2 extends Dispatch implements IMdcText {
  ...
  public TextBox2() throws ComException {
    super("{DD4CB8C5-F540-47FF-84D7-67390D2743CA}", "{8BD21D13-EC42-11CE-9E0D-00AA006002F3}");
  }
  protected TextBox2(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[TextBox2" + super.toString() + "]";
  }
}
