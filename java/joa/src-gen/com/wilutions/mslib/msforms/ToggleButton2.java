 ...
 * 
 */
@CoClass(guid="{3D0FD779-0C2D-4708-A9BA-62F7458A5A53}")
public class ToggleButton2 extends Dispatch implements IMdcToggleButton {
  ...
  public ToggleButton2() throws ComException {
    super("{3D0FD779-0C2D-4708-A9BA-62F7458A5A53}", "{8BD21D63-EC42-11CE-9E0D-00AA006002F3}");
  }
  protected ToggleButton2(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ToggleButton2" + super.toString() + "]";
  }
}
