 ...
 * 
 */
@CoClass(guid="{E9729012-8271-4E1F-BC56-CF85F914915A}")
public class CheckBox2 extends Dispatch implements IMdcCheckBox {
  ...
  public CheckBox2() throws ComException {
    super("{E9729012-8271-4E1F-BC56-CF85F914915A}", "{8BD21D43-EC42-11CE-9E0D-00AA006002F3}");
  }
  protected CheckBox2(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[CheckBox2" + super.toString() + "]";
  }
}
