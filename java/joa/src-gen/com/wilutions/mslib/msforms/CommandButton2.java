 ...
 * 
 */
@CoClass(guid="{86F56B7F-A81B-478D-B231-50FD37CBE761}")
public class CommandButton2 extends Dispatch implements ICommandButton {
  ...
  public CommandButton2() throws ComException {
    super("{86F56B7F-A81B-478D-B231-50FD37CBE761}", "{04598FC4-866C-11CF-AB7C-00AA00C08FCF}");
  }
  protected CommandButton2(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[CommandButton2" + super.toString() + "]";
  }
}
