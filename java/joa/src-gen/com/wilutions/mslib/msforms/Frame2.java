 ...
 * 
 */
@CoClass(guid="{7931F65C-2564-4C19-AE71-E7DDFA008F6A}")
public class Frame2 extends Dispatch implements IOptionFrame {
  ...
  public Frame2() throws ComException {
    super("{7931F65C-2564-4C19-AE71-E7DDFA008F6A}", "{29B86A70-F52E-11CE-9BCE-00AA00608E01}");
  }
  protected Frame2(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[Frame2" + super.toString() + "]";
  }
}
