 ...
 * 
 */
@CoClass(guid="{00061051-0000-0000-C000-000000000046}")
public class TaskRequestUpdateItem extends Dispatch implements _TaskRequestUpdateItem {
  ...
  public TaskRequestUpdateItem() throws ComException {
    super("{00061051-0000-0000-C000-000000000046}", "{00063037-0000-0000-C000-000000000046}");
  }
