 ...
 * 
 */
@CoClass(guid="{000610DF-0000-0000-C000-000000000046}")
public class SenderInAddressListRuleCondition extends Dispatch implements _SenderInAddressListRuleCondition {
  ...
  @DeclDISPID(64327)  public void setAddressList(final AddressList value) throws ComException {
