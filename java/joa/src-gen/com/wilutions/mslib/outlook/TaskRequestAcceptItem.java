...
public class TaskRequestAcceptItem extends Dispatch implements _TaskRequestAcceptItem {
  ...
  @DeclDISPID(61460)  public TaskItem GetAssociatedTask(Boolean AddToTaskList) throws ComException {
  ...
  public TaskRequestAcceptItem() throws ComException {
    super("{00061052-0000-0000-C000-000000000046}");
  }
  protected TaskRequestAcceptItem(long ndisp) {
    super(ndisp);
  }
  public TaskRequestAcceptItem(Dispatch ndisp) {
    super(ndisp);
  }
