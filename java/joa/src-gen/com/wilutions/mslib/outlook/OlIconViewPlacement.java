...
public class OlIconViewPlacement implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & 0) != 0) sbuf.append("|olIconDoNotArrange");
      if ((value & 1) != 0) sbuf.append("|olIconLineUp");
      if ((value & 2) != 0) sbuf.append("|olIconAutoArrange");
      if ((value & 3) != 0) sbuf.append("|olIconSortAndAutoArrange");
