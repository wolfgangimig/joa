...
public class OlPane implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & 1) != 0) sbuf.append("|olOutlookBar");
      if ((value & 2) != 0) sbuf.append("|olFolderList");
      if ((value & 3) != 0) sbuf.append("|olPreview");
      if ((value & 4) != 0) sbuf.append("|olNavigationPane");
      if ((value & 5) != 0) sbuf.append("|olToDoBar");
