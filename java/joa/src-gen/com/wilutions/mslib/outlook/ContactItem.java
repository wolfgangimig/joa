 ...
 * 
 */
@CoClass(guid="{00061031-0000-0000-C000-000000000046}")
public class ContactItem extends Dispatch implements _ContactItem {
  ...
  @DeclDISPID(64528)  public OlBusinessCardType getBusinessCardType() throws ComException {
    ...
    if (obj == null) return null;
    return OlBusinessCardType.valueOf((Integer)obj);
  }
  ...
  public ContactItem() throws ComException {
    super("{00061031-0000-0000-C000-000000000046}", "{00063021-0000-0000-C000-000000000046}");
  }
