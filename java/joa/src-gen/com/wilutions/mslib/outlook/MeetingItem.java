 ...
 * 
 */
@CoClass(guid="{00061036-0000-0000-C000-000000000046}")
public class MeetingItem extends Dispatch implements _MeetingItem {
  ...
  @DeclDISPID(63328)  public AppointmentItem GetAssociatedAppointment(final Boolean AddToCalendar) throws ComException {
    ...
    if (obj == null) return null;
    final Dispatch disp = (Dispatch)obj;
    return disp.as(AppointmentItem.class);
  }
