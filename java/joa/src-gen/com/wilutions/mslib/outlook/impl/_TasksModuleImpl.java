...
@CoClass(guid="{C091A987-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _TasksModuleImpl extends Dispatch implements com.wilutions.mslib.outlook._TasksModule {
  ...
  public _TasksModuleImpl(String progId) throws ComException {
    super(progId, "{000630EC-0000-0000-C000-000000000046}");
  }
