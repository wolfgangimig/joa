...
@CoClass(guid="{C091A9A4-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _RuleActionImpl extends Dispatch implements com.wilutions.mslib.outlook._RuleAction {
  ...
  public _RuleActionImpl(Dispatch ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[_RuleActionImpl" + super.toString() + "]";
  }
}
