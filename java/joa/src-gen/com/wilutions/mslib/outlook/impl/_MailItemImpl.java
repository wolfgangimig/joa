...
public class _MailItemImpl extends Dispatch implements com.wilutions.mslib.outlook._MailItem {
  ...
  @DeclDISPID(61467)  public void setVotingOptions(final String value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(34084)  public void setVotingResponse(final String value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(64635)  public void setSender(final com.wilutions.mslib.outlook.AddressEntry value) throws ComException {
    this._dispatchCall(64635,"Sender", DISPATCH_PROPERTYPUT,Dispatch.param(value));
  }
