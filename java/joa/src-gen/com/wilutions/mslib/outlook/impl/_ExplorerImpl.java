...
public class _ExplorerImpl extends Dispatch implements com.wilutions.mslib.outlook._Explorer {
  ...
  @DeclDISPID(8707)  public Boolean IsPaneVisible(final com.wilutions.mslib.outlook.OlPane Pane) throws ComException {
    assert(Pane != null);
    final Object obj = this._dispatchCall(8707,"IsPaneVisible", DISPATCH_METHOD,null,Pane.value);
    if (obj == null) return null;
    return (Boolean)obj;
  }
  @DeclDISPID(8708)  public void ShowPane(final com.wilutions.mslib.outlook.OlPane Pane, final Boolean Visible) throws ComException {
    assert(Pane != null);
    assert(Visible != null);
  ...
  @DeclDISPID(64101)  public void Search(final String Query, final com.wilutions.mslib.outlook.OlSearchScope SearchScope) throws ComException {
    assert(Query != null);
