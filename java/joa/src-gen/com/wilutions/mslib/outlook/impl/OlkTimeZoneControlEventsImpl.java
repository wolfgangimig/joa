...
@CoClass(guid="{C091EA03-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkTimeZoneControlEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkTimeZoneControlEvents {
  ...
  public OlkTimeZoneControlEventsImpl(String progId) throws ComException {
    super(progId, "{00067368-0000-0000-C000-000000000046}");
  }
  protected OlkTimeZoneControlEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkTimeZoneControlEventsImpl" + super.toString() + "]";
  }
}
