...
public class ReminderCollectionEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.ReminderCollectionEvents {
  ...
  @DeclDISPID(64148)  public void onReminderAdd(com.wilutions.mslib.outlook._Reminder ReminderObject) throws ComException {
    this._dispatchCall(64148,"ReminderAdd", DISPATCH_METHOD,null,(ReminderObject!=null?ReminderObject:Dispatch.NULL));
  }
  @DeclDISPID(64149)  public void onReminderChange(com.wilutions.mslib.outlook._Reminder ReminderObject) throws ComException {
    this._dispatchCall(64149,"ReminderChange", DISPATCH_METHOD,null,(ReminderObject!=null?ReminderObject:Dispatch.NULL));
  }
  @DeclDISPID(64150)  public void onReminderFire(com.wilutions.mslib.outlook._Reminder ReminderObject) throws ComException {
  ...
  @DeclDISPID(64152)  public void onSnooze(com.wilutions.mslib.outlook._Reminder ReminderObject) throws ComException {
