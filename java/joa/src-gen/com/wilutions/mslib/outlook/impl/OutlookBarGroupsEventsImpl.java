...
public class OutlookBarGroupsEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OutlookBarGroupsEvents {
  @DeclDISPID(61441)  public void onGroupAdd(com.wilutions.mslib.outlook.OutlookBarGroup NewGroup) throws ComException {
  ...
  @DeclDISPID(61443)  public void onBeforeGroupRemove(com.wilutions.mslib.outlook.OutlookBarGroup Group, ByRef<Boolean> Cancel) throws ComException {
    assert(Cancel != null);
