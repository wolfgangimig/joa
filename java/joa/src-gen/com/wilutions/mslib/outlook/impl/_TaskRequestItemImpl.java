...
@CoClass(guid="{C091A95D-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _TaskRequestItemImpl extends Dispatch implements com.wilutions.mslib.outlook._TaskRequestItem {
  ...
  public _TaskRequestItemImpl(String progId) throws ComException {
    super(progId, "{00063036-0000-0000-C000-000000000046}");
  }
