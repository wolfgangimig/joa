...
@CoClass(guid="{C091EB9E-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkCategoryEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkCategoryEvents {
  ...
  public OlkCategoryEventsImpl(String progId) throws ComException {
    super(progId, "{000672F5-0000-0000-C000-000000000046}");
  }
  protected OlkCategoryEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkCategoryEventsImpl" + super.toString() + "]";
  }
}
