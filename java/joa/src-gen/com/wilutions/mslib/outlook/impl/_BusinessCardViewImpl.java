...
@CoClass(guid="{C091A9C9-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _BusinessCardViewImpl extends Dispatch implements com.wilutions.mslib.outlook._BusinessCardView {
  ...
  @DeclDISPID(64474)  public Integer getCardSize() throws ComException {
    final Object obj = this._dispatchCall(64474,"CardSize", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return (Integer)obj;
  }
  @DeclDISPID(64474)  public void setCardSize(final Integer value) throws ComException {
    assert(value != null);
    this._dispatchCall(64474,"CardSize", DISPATCH_PROPERTYPUT,value);
  }
  public _BusinessCardViewImpl(String progId) throws ComException {
    super(progId, "{000630A2-0000-0000-C000-000000000046}");
  }
