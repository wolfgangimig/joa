...
@CoClass(guid="{C091EB8F-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkListBoxEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkListBoxEvents {
  ...
  public OlkListBoxEventsImpl(String progId) throws ComException {
    super(progId, "{000672E4-0000-0000-C000-000000000046}");
  }
  protected OlkListBoxEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkListBoxEventsImpl" + super.toString() + "]";
  }
}
