...
@CoClass(guid="{C091EB90-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkDateControlEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkDateControlEvents {
  ...
  public OlkDateControlEventsImpl(String progId) throws ComException {
    super(progId, "{000672FB-0000-0000-C000-000000000046}");
  }
  protected OlkDateControlEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkDateControlEventsImpl" + super.toString() + "]";
  }
}
