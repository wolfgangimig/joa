...
@CoClass(guid="{C091EBB2-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _OlkLabelImpl extends Dispatch implements com.wilutions.mslib.outlook._OlkLabel {
  ...
  public String toString() {
    return "[_OlkLabelImpl" + super.toString() + "]";
  }
}
