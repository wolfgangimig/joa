...
@CoClass(guid="{C091A958-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _AppointmentItemImpl extends Dispatch implements com.wilutions.mslib.outlook._AppointmentItem {
  ...
  @DeclDISPID(33285)  public com.wilutions.mslib.outlook.OlBusyStatus getBusyStatus() throws ComException {
    final Object obj = this._dispatchCall(33285,"BusyStatus", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.outlook.OlBusyStatus.valueOf((Integer)obj);
  }
  @DeclDISPID(33285)  public void setBusyStatus(com.wilutions.mslib.outlook.OlBusyStatus value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(33303)  public com.wilutions.mslib.outlook.OlMeetingStatus getMeetingStatus() throws ComException {
    final Object obj = this._dispatchCall(33303,"MeetingStatus", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.outlook.OlMeetingStatus.valueOf((Integer)obj);
  }
  @DeclDISPID(33303)  public void setMeetingStatus(com.wilutions.mslib.outlook.OlMeetingStatus value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(62789)  public com.wilutions.mslib.outlook.OlRecurrenceState getRecurrenceState() throws ComException {
    final Object obj = this._dispatchCall(62789,"RecurrenceState", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.outlook.OlRecurrenceState.valueOf((Integer)obj);
  }
  ...
  @DeclDISPID(33304)  public com.wilutions.mslib.outlook.OlResponseStatus getResponseStatus() throws ComException {
  ...
  @DeclDISPID(62791)  public com.wilutions.mslib.outlook.MailItem ForwardAsVcal() throws ComException {
  ...
  @DeclDISPID(62722)  public com.wilutions.mslib.outlook.MeetingItem Respond(com.wilutions.mslib.outlook.OlMeetingResponse Response, Object fNoUI, Object fAdditionalTextDialog) throws ComException {
    ...
    if (obj == null) return null;
    final Dispatch disp = (Dispatch)obj;
    return disp.uncheckedAs(com.wilutions.mslib.outlook.MeetingItem.class);
  }
  ...
  @DeclDISPID(64551)  public com.wilutions.mslib.outlook._TimeZone getStartTimeZone() throws ComException {
  ...
  @DeclDISPID(64551)  public void setStartTimeZone(com.wilutions.mslib.outlook._TimeZone value) throws ComException {
  ...
  @DeclDISPID(64552)  public void setEndTimeZone(com.wilutions.mslib.outlook._TimeZone value) throws ComException {
  ...
  @DeclDISPID(64274)  public com.wilutions.mslib.outlook._AppointmentItem CopyTo(com.wilutions.mslib.outlook.MAPIFolder DestinationFolder, com.wilutions.mslib.outlook.OlAppointmentCopyOptions CopyOptions) throws ComException {
  ...
  @DeclDISPID(64648)  public com.wilutions.mslib.outlook.AddressEntry GetOrganizer() throws ComException {
  ...
  public _AppointmentItemImpl(String progId) throws ComException {
    super(progId, "{00063033-0000-0000-C000-000000000046}");
  }
