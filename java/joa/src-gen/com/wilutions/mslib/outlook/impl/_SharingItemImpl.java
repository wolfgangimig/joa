...
public class _SharingItemImpl extends Dispatch implements com.wilutions.mslib.outlook._SharingItem {
  ...
  @DeclDISPID(64507)  public com.wilutions.mslib.outlook.SharingItem Deny() throws ComException {
    ...
    if (obj == null) return null;
    final Dispatch disp = (Dispatch)obj;
    return disp.uncheckedAs(com.wilutions.mslib.outlook.SharingItem.class);
  }
  ...
  @DeclDISPID(64504)  public void setAllowWriteAccess(Boolean value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(64505)  public void setType(com.wilutions.mslib.outlook.OlSharingMsgType value) throws ComException {
    assert(value != null);
