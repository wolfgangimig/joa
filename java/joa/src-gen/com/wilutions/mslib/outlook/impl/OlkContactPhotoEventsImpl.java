...
@CoClass(guid="{C091EB87-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkContactPhotoEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkContactPhotoEvents {
  ...
  public OlkContactPhotoEventsImpl(String progId) throws ComException {
    super(progId, "{000672EC-0000-0000-C000-000000000046}");
  }
  protected OlkContactPhotoEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkContactPhotoEventsImpl" + super.toString() + "]";
  }
}
