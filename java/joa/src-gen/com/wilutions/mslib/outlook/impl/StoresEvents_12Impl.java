...
public class StoresEvents_12Impl extends Dispatch implements com.wilutions.mslib.outlook.StoresEvents_12 {
  @DeclDISPID(64433)  public void onBeforeStoreRemove(com.wilutions.mslib.outlook._Store Store, ByRef<Boolean> Cancel) throws ComException {
    assert(Cancel != null);
    this._dispatchCall(64433,"BeforeStoreRemove", DISPATCH_METHOD,null,(Store!=null?Store:Dispatch.NULL),Cancel);
  }
  @DeclDISPID(61441)  public void onStoreAdd(com.wilutions.mslib.outlook._Store Store) throws ComException {
