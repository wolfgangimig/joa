...
@CoClass(guid="{C091A981-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _CalendarModuleImpl extends Dispatch implements com.wilutions.mslib.outlook._CalendarModule {
  ...
  public _CalendarModuleImpl(String progId) throws ComException {
    super(progId, "{000630EA-0000-0000-C000-000000000046}");
  }
