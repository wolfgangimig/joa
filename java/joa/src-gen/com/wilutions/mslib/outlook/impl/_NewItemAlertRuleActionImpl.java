...
@CoClass(guid="{C091A9BC-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _NewItemAlertRuleActionImpl extends Dispatch implements com.wilutions.mslib.outlook._NewItemAlertRuleAction {
  ...
  public _NewItemAlertRuleActionImpl(Dispatch ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[_NewItemAlertRuleActionImpl" + super.toString() + "]";
  }
}
