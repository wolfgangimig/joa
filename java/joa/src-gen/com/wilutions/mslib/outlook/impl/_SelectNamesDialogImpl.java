...
@CoClass(guid="{C091A9A3-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _SelectNamesDialogImpl extends Dispatch implements com.wilutions.mslib.outlook._SelectNamesDialog {
  ...
  @DeclDISPID(63508)  public void setRecipients(com.wilutions.mslib.outlook.Recipients value) throws ComException {
  ...
  @DeclDISPID(64233)  public com.wilutions.mslib.outlook.OlRecipientSelectors getNumberOfRecipientSelectors() throws ComException {
    final Object obj = this._dispatchCall(64233,"NumberOfRecipientSelectors", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.outlook.OlRecipientSelectors.valueOf((Integer)obj);
  }
  @DeclDISPID(64233)  public void setNumberOfRecipientSelectors(com.wilutions.mslib.outlook.OlRecipientSelectors value) throws ComException {
    assert(value != null);
    this._dispatchCall(64233,"NumberOfRecipientSelectors", DISPATCH_PROPERTYPUT,value.value);
  }
  @DeclDISPID(64234)  public com.wilutions.mslib.outlook.AddressList getInitialAddressList() throws ComException {
  ...
  @DeclDISPID(64234)  public void setInitialAddressList(com.wilutions.mslib.outlook.AddressList value) throws ComException {
    this._dispatchCall(64234,"InitialAddressList", DISPATCH_PROPERTYPUT,(value!=null?value:Dispatch.NULL));
  }
  @DeclDISPID(64235)  public void SetDefaultDisplayMode(com.wilutions.mslib.outlook.OlDefaultSelectNamesDisplayMode defaultMode) throws ComException {
