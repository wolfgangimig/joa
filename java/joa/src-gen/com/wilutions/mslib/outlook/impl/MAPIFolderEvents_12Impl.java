...
public class MAPIFolderEvents_12Impl extends Dispatch implements com.wilutions.mslib.outlook.MAPIFolderEvents_12 {
  @DeclDISPID(64424)  public void onBeforeFolderMove(com.wilutions.mslib.outlook.MAPIFolder MoveTo, ByRef<Boolean> Cancel) throws ComException {
    assert(Cancel != null);
    this._dispatchCall(64424,"BeforeFolderMove", DISPATCH_METHOD,null,(MoveTo!=null?MoveTo:Dispatch.NULL),Cancel);
  }
  @DeclDISPID(64425)  public void onBeforeItemMove(IDispatch Item, com.wilutions.mslib.outlook.MAPIFolder MoveTo, ByRef<Boolean> Cancel) throws ComException {
    assert(Cancel != null);
