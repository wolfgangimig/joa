...
@CoClass(guid="{C091EB9B-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkTimeControlEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkTimeControlEvents {
  ...
  public OlkTimeControlEventsImpl(String progId) throws ComException {
    super(progId, "{000672F0-0000-0000-C000-000000000046}");
  }
  protected OlkTimeControlEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkTimeControlEventsImpl" + super.toString() + "]";
  }
}
