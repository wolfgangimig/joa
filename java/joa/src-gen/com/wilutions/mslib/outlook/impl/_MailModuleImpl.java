...
@CoClass(guid="{C091A982-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _MailModuleImpl extends Dispatch implements com.wilutions.mslib.outlook._MailModule {
  ...
  public _MailModuleImpl(String progId) throws ComException {
    super(progId, "{000630E9-0000-0000-C000-000000000046}");
  }
