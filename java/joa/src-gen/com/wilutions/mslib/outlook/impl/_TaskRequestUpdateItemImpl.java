...
@CoClass(guid="{C091A95C-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _TaskRequestUpdateItemImpl extends Dispatch implements com.wilutions.mslib.outlook._TaskRequestUpdateItem {
  ...
  @DeclDISPID(61460)  public com.wilutions.mslib.outlook.TaskItem GetAssociatedTask(Boolean AddToTaskList) throws ComException {
    assert(AddToTaskList != null);
    final Object obj = this._dispatchCall(61460,"GetAssociatedTask", DISPATCH_METHOD,null,AddToTaskList);
    if (obj == null) return null;
    final Dispatch disp = (Dispatch)obj;
    return disp.uncheckedAs(com.wilutions.mslib.outlook.TaskItem.class);
  }
  ...
  public _TaskRequestUpdateItemImpl(String progId) throws ComException {
    super(progId, "{00063037-0000-0000-C000-000000000046}");
  }
  protected _TaskRequestUpdateItemImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[_TaskRequestUpdateItemImpl" + super.toString() + "]";
  }
}
