...
@CoClass(guid="{C091A9FC-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _IconViewImpl extends Dispatch implements com.wilutions.mslib.outlook._IconView {
  ...
  @DeclDISPID(64362)  public com.wilutions.mslib.outlook.OlIconViewType getIconViewType() throws ComException {
    final Object obj = this._dispatchCall(64362,"IconViewType", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.outlook.OlIconViewType.valueOf((Integer)obj);
  }
  @DeclDISPID(64362)  public void setIconViewType(final com.wilutions.mslib.outlook.OlIconViewType value) throws ComException {
    assert(value != null);
    this._dispatchCall(64362,"IconViewType", DISPATCH_PROPERTYPUT,value.value);
  }
  @DeclDISPID(64363)  public com.wilutions.mslib.outlook.OlIconViewPlacement getIconPlacement() throws ComException {
    final Object obj = this._dispatchCall(64363,"IconPlacement", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.outlook.OlIconViewPlacement.valueOf((Integer)obj);
  }
  @DeclDISPID(64363)  public void setIconPlacement(final com.wilutions.mslib.outlook.OlIconViewPlacement value) throws ComException {
    assert(value != null);
