...
@CoClass(guid="{C091A94F-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _PostItemImpl extends Dispatch implements com.wilutions.mslib.outlook._PostItem {
  ...
  @DeclDISPID(61557)  public void Post() throws ComException {
    this._dispatchCall(61557,"Post", DISPATCH_METHOD,null);
  }
  ...
  public _PostItemImpl(String progId) throws ComException {
    super(progId, "{00063024-0000-0000-C000-000000000046}");
  }
  protected _PostItemImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[_PostItemImpl" + super.toString() + "]";
  }
}
