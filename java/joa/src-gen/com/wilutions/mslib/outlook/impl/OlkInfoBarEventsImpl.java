...
@CoClass(guid="{C091EB9C-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkInfoBarEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkInfoBarEvents {
  ...
  public OlkInfoBarEventsImpl(String progId) throws ComException {
    super(progId, "{000672F7-0000-0000-C000-000000000046}");
  }
  protected OlkInfoBarEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkInfoBarEventsImpl" + super.toString() + "]";
  }
}
