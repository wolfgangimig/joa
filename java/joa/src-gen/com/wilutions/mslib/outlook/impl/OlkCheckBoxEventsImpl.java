...
@CoClass(guid="{C091EB89-A463-DB41-5DAE-69E7A5F7FCBC}")
public class OlkCheckBoxEventsImpl extends Dispatch implements com.wilutions.mslib.outlook.OlkCheckBoxEvents {
  ...
  public OlkCheckBoxEventsImpl(String progId) throws ComException {
    super(progId, "{000672E2-0000-0000-C000-000000000046}");
  }
  protected OlkCheckBoxEventsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[OlkCheckBoxEventsImpl" + super.toString() + "]";
  }
}
