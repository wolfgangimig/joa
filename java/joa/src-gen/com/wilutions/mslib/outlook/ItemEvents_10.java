...
public interface ItemEvents_10 extends IDispatch {
  ...
  @DeclDISPID(61446)  public void onCustomAction(Dispatch Action, Dispatch Response, ByRef<Boolean> Cancel) throws ComException;
  @DeclDISPID(61448)  public void onCustomPropertyChange(String Name) throws ComException;
  @DeclDISPID(62568)  public void onForward(Dispatch Forward, ByRef<Boolean> Cancel) throws ComException;
  ...
  @DeclDISPID(62566)  public void onReply(Dispatch Response, ByRef<Boolean> Cancel) throws ComException;
  @DeclDISPID(62567)  public void onReplyAll(Dispatch Response, ByRef<Boolean> Cancel) throws ComException;
  ...
  @DeclDISPID(64117)  public void onBeforeDelete(Dispatch Item, ByRef<Boolean> Cancel) throws ComException;
