 ...
 * 
 */
@CoClass(guid="{000610CF-0000-0000-C000-000000000046}")
public class RuleAction extends Dispatch implements _RuleAction {
  ...
  public RuleAction(Dispatch ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[RuleAction" + super.toString() + "]";
  }
}
