 ...
 * 
 */
@CoInterface(guid="{000C030D-0000-0000-C000-000000000046}")
public interface _CommandBarActiveX extends IDispatch {
  ...
  @DeclDISPID(1610940416)  public void setControlCLSID(String value) throws ComException;
  @DeclDISPID(1610940418)  public Object getQueryControlInterface(String bstrIid) throws ComException;
  @DeclDISPID(1610940419)  public void SetInnerObjectFactory(Object pUnk) throws ComException;
  @DeclDISPID(1610940420)  public void EnsureControl() throws ComException;
  @DeclDISPID(1610940421)  public void setInitWith(Object value) throws ComException;
}
