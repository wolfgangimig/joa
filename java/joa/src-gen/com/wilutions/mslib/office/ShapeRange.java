...
public interface ShapeRange extends IDispatch {
  ...
  @DeclDISPID(10)  public void Align(MsoAlignCmd AlignCmd, MsoTriState RelativeTo) throws ComException;
  @DeclDISPID(11)  public void Apply() throws ComException;
  @DeclDISPID(12)  public void Delete() throws ComException;
  @DeclDISPID(13)  public void Distribute(MsoDistributeCmd DistributeCmd, MsoTriState RelativeTo) throws ComException;
  @DeclDISPID(14)  public ShapeRange Duplicate() throws ComException;
  @DeclDISPID(15)  public void Flip(MsoFlipCmd FlipCmd) throws ComException;
  ...
  @DeclDISPID(23)  public void ScaleHeight(Float Factor, MsoTriState RelativeToOriginalSize, MsoScaleFrom fScale) throws ComException;
  @DeclDISPID(24)  public void ScaleWidth(Float Factor, MsoTriState RelativeToOriginalSize, MsoScaleFrom fScale) throws ComException;
  ...
  @DeclDISPID(28)  public void ZOrder(MsoZOrderCmd ZOrderCmd) throws ComException;
  ...
  @DeclDISPID(156)  public void MergeShapes(MsoMergeCmd MergeCmd, Shape PrimaryShape) throws ComException;
}
