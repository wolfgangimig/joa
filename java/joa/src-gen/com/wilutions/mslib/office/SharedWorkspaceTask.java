...
public interface SharedWorkspaceTask extends IDispatch {
  ...
  @DeclDISPID(2)  public void setStatus(final MsoSharedWorkspaceTaskStatus value) throws ComException;
  @DeclDISPID(3)  public MsoSharedWorkspaceTaskPriority getPriority() throws ComException;
  @DeclDISPID(3)  public void setPriority(final MsoSharedWorkspaceTaskPriority value) throws ComException;
  ...
  @DeclDISPID(12)  public IDispatch getParent() throws ComException;
}
