...
public class MsoPatternType implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & 30) != 0) sbuf.append("|msoPatternNarrowHorizontal");
      if ((value & 7) != 0) sbuf.append("|msoPattern50Percent");
      if ((value & -2) != 0) sbuf.append("|msoPatternMixed");
      if ((value & 36) != 0) sbuf.append("|msoPatternLargeCheckerBoard");
      if ((value & 1) != 0) sbuf.append("|msoPattern5Percent");
      if ((value & 35) != 0) sbuf.append("|msoPatternHorizontalBrick");
      if ((value & 2) != 0) sbuf.append("|msoPattern10Percent");
      if ((value & 34) != 0) sbuf.append("|msoPatternLargeGrid");
      if ((value & 3) != 0) sbuf.append("|msoPattern20Percent");
      if ((value & 33) != 0) sbuf.append("|msoPatternLargeConfetti");
      if ((value & 4) != 0) sbuf.append("|msoPattern25Percent");
      if ((value & 32) != 0) sbuf.append("|msoPatternDashedHorizontal");
      if ((value & 5) != 0) sbuf.append("|msoPattern30Percent");
      if ((value & 31) != 0) sbuf.append("|msoPatternDashedVertical");
      if ((value & 6) != 0) sbuf.append("|msoPattern40Percent");
      if ((value & 8) != 0) sbuf.append("|msoPattern60Percent");
      if ((value & 9) != 0) sbuf.append("|msoPattern70Percent");
      if ((value & 29) != 0) sbuf.append("|msoPatternNarrowVertical");
      if ((value & 10) != 0) sbuf.append("|msoPattern75Percent");
      if ((value & 28) != 0) sbuf.append("|msoPatternDashedDownwardDiagonal");
      if ((value & 11) != 0) sbuf.append("|msoPattern80Percent");
      if ((value & 12) != 0) sbuf.append("|msoPattern90Percent");
      if ((value & 13) != 0) sbuf.append("|msoPatternDarkHorizontal");
      if ((value & 14) != 0) sbuf.append("|msoPatternDarkVertical");
      if ((value & 15) != 0) sbuf.append("|msoPatternDarkDownwardDiagonal");
      if ((value & 16) != 0) sbuf.append("|msoPatternDarkUpwardDiagonal");
      if ((value & 17) != 0) sbuf.append("|msoPatternSmallCheckerBoard");
      if ((value & 54) != 0) sbuf.append("|msoPatternDiagonalCross");
      if ((value & 21) != 0) sbuf.append("|msoPatternLightDownwardDiagonal");
      if ((value & 18) != 0) sbuf.append("|msoPatternTrellis");
      if ((value & 20) != 0) sbuf.append("|msoPatternLightVertical");
      if ((value & 19) != 0) sbuf.append("|msoPatternLightHorizontal");
      if ((value & 22) != 0) sbuf.append("|msoPatternLightUpwardDiagonal");
      if ((value & 23) != 0) sbuf.append("|msoPatternSmallGrid");
      if ((value & 51) != 0) sbuf.append("|msoPatternCross");
      if ((value & 24) != 0) sbuf.append("|msoPatternDottedDiamond");
      if ((value & 50) != 0) sbuf.append("|msoPatternVertical");
      if ((value & 25) != 0) sbuf.append("|msoPatternWideDownwardDiagonal");
      if ((value & 53) != 0) sbuf.append("|msoPatternUpwardDiagonal");
      if ((value & 26) != 0) sbuf.append("|msoPatternWideUpwardDiagonal");
      if ((value & 52) != 0) sbuf.append("|msoPatternDownwardDiagonal");
      if ((value & 27) != 0) sbuf.append("|msoPatternDashedUpwardDiagonal");
      if ((value & 37) != 0) sbuf.append("|msoPatternSmallConfetti");
      if ((value & 38) != 0) sbuf.append("|msoPatternZigZag");
      if ((value & 39) != 0) sbuf.append("|msoPatternSolidDiamond");
      if ((value & 40) != 0) sbuf.append("|msoPatternDiagonalBrick");
      if ((value & 41) != 0) sbuf.append("|msoPatternOutlinedDiamond");
      if ((value & 42) != 0) sbuf.append("|msoPatternPlaid");
      if ((value & 43) != 0) sbuf.append("|msoPatternSphere");
      if ((value & 44) != 0) sbuf.append("|msoPatternWeave");
      if ((value & 45) != 0) sbuf.append("|msoPatternDottedGrid");
      if ((value & 46) != 0) sbuf.append("|msoPatternDivot");
      if ((value & 47) != 0) sbuf.append("|msoPatternShingle");
      if ((value & 48) != 0) sbuf.append("|msoPatternWave");
      if ((value & 49) != 0) sbuf.append("|msoPatternHorizontal");
