...
public class MsoSmartArtNodePosition implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & 1) != 0) sbuf.append("|msoSmartArtNodeDefault");
      if ((value & 2) != 0) sbuf.append("|msoSmartArtNodeAfter");
      if ((value & 3) != 0) sbuf.append("|msoSmartArtNodeBefore");
      if ((value & 4) != 0) sbuf.append("|msoSmartArtNodeAbove");
      if ((value & 5) != 0) sbuf.append("|msoSmartArtNodeBelow");
