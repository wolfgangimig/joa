...
@CoClass(guid="{C09B8E41-A463-DB41-5DAE-69E7A5F7FCBC}")
public class IMsoUpBarsImpl extends Dispatch implements com.wilutions.mslib.office.IMsoUpBars {
  ...
  public IMsoUpBarsImpl(String progId) throws ComException {
    super(progId, "{000C172A-0000-0000-C000-000000000046}");
  }
