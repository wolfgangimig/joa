...
@CoClass(guid="{C09B9AA9-A463-DB41-5DAE-69E7A5F7FCBC}")
public class RulerLevels2Impl extends Dispatch implements com.wilutions.mslib.office.RulerLevels2 {
  ...
  @DeclDISPID(0)  public com.wilutions.mslib.office.RulerLevel2 Item(Object Index) throws ComException {
    ...
    return disp.uncheckedAs(com.wilutions.mslib.office.impl.RulerLevel2Impl.class);
  }
