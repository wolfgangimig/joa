...
public class WorkflowTemplatesImpl extends Dispatch implements com.wilutions.mslib.office.WorkflowTemplates {
  ...
  @DeclDISPID(0)  public com.wilutions.mslib.office.WorkflowTemplate getItem(final Integer Index) throws ComException {
    assert(Index != null);
    final Object obj = this._dispatchCall(0,"Item", DISPATCH_PROPERTYGET,null,Index);
    if (obj == null) return null;
    return Dispatch.as(obj, com.wilutions.mslib.office.impl.WorkflowTemplateImpl.class);
  }
