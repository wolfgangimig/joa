...
public class ChartGroupsImpl extends Dispatch implements com.wilutions.mslib.office.ChartGroups {
  ...
  @DeclDISPID(170)  public com.wilutions.mslib.office.IMsoChartGroup Item(final Object Index) throws ComException {
    assert(Index != null);
    final Object obj = this._dispatchCall(170,"Item", DISPATCH_METHOD,null,Index);
    if (obj == null) return null;
    return Dispatch.as(obj, com.wilutions.mslib.office.impl.IMsoChartGroupImpl.class);
  }
  ...
  public ChartGroupsImpl(String progId) throws ComException {
    super(progId, "{000C172B-0000-0000-C000-000000000046}");
  }
