...
@CoClass(guid="{C09B9A67-A463-DB41-5DAE-69E7A5F7FCBC}")
public class _CommandBarComboBoxImpl extends Dispatch implements com.wilutions.mslib.office._CommandBarComboBox {
  ...
  @DeclDISPID(1610940430)  public com.wilutions.mslib.office.MsoComboStyle getStyle() throws ComException {
    final Object obj = this._dispatchCall(1610940430,"Style", DISPATCH_PROPERTYGET,null);
    if (obj == null) return null;
    return com.wilutions.mslib.office.MsoComboStyle.valueOf((Integer)obj);
  }
  @DeclDISPID(1610940430)  public void setStyle(final com.wilutions.mslib.office.MsoComboStyle value) throws ComException {
    assert(value != null);
  ...
  public _CommandBarComboBoxImpl(String progId) throws ComException {
    super(progId, "{000C030C-0000-0000-C000-000000000046}");
  }
