...
public class COMAddInsImpl extends Dispatch implements com.wilutions.mslib.office.COMAddIns {
  ...
  @DeclDISPID(0)  public com.wilutions.mslib.office.COMAddIn Item(Object Index) throws ComException {
    assert(Index != null);
    final Object obj = this._dispatchCall(0,"Item", DISPATCH_METHOD,null,Index);
    if (obj == null) return null;
    final Dispatch disp = (Dispatch)obj;
    return disp.uncheckedAs(com.wilutions.mslib.office.impl.COMAddInImpl.class);
  }
  ...
  public COMAddInsImpl(Dispatch ndisp) {
    super(ndisp);
  }
