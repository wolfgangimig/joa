...
public class PickerFieldsImpl extends Dispatch implements com.wilutions.mslib.office.PickerFields {
  ...
  public PickerFieldsImpl(String progId) throws ComException {
    super(progId, "{000C03E1-0000-0000-C000-000000000046}");
  }
  protected PickerFieldsImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[PickerFieldsImpl" + super.toString() + "]";
  }
}
