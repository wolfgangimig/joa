...
public class LegendEntriesImpl extends Dispatch implements com.wilutions.mslib.office.LegendEntries {
  ...
  @DeclDISPID(170)  public com.wilutions.mslib.office.LegendEntry Item(final Object Index) throws ComException {
    assert(Index != null);
  ...
  @DeclDISPID(0)  public com.wilutions.mslib.office.LegendEntry get_Default(final Object Index) throws ComException {
    assert(Index != null);
