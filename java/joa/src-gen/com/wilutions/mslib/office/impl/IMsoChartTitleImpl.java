...
@CoClass(guid="{C09B8E64-A463-DB41-5DAE-69E7A5F7FCBC}")
public class IMsoChartTitleImpl extends Dispatch implements com.wilutions.mslib.office.IMsoChartTitle {
  ...
  public IMsoChartTitleImpl(Dispatch ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[IMsoChartTitleImpl" + super.toString() + "]";
  }
}
