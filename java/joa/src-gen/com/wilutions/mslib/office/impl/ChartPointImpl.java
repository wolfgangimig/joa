...
public class ChartPointImpl extends Dispatch implements com.wilutions.mslib.office.ChartPoint {
  ...
  @DeclDISPID(2656)  public Double PieSliceLocation(final com.wilutions.mslib.office.XlPieSliceLocation loc, final com.wilutions.mslib.office.XlPieSliceIndex Index) throws ComException {
    assert(loc != null);
    assert(Index != null);
