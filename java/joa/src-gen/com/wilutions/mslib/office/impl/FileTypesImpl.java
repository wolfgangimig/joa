...
public class FileTypesImpl extends Dispatch implements com.wilutions.mslib.office.FileTypes {
  ...
  @DeclDISPID(0)  public com.wilutions.mslib.office.MsoFileType getItem(final Integer Index) throws ComException {
    assert(Index != null);
  ...
  @DeclDISPID(3)  public void Add(final com.wilutions.mslib.office.MsoFileType FileType) throws ComException {
