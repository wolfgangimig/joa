...
public interface ConnectorFormat extends IDispatch {
  ...
  @DeclDISPID(10)  public void BeginConnect(Shape ConnectedShape, Integer ConnectionSite) throws ComException;
  @DeclDISPID(11)  public void BeginDisconnect() throws ComException;
  @DeclDISPID(12)  public void EndConnect(Shape ConnectedShape, Integer ConnectionSite) throws ComException;
  ...
  @DeclDISPID(106)  public void setType(MsoConnectorType value) throws ComException;
}
