...
public interface Shapes extends IDispatch {
  ...
  @DeclDISPID(28)  public Shape AddSmartArt(final SmartArtLayout Layout, final Float Left, final Float Top, final Float Width, final Float Height) throws ComException;
  @DeclDISPID(29)  public Shape AddChart2(final Integer Style, final XlChartType Type, final Float Left, final Float Top, final Float Width, final Float Height, final Boolean NewLayout) throws ComException;
  @DeclDISPID(30)  public Shape AddPicture2(final String FileName, final MsoTriState LinkToFile, final MsoTriState SaveWithDocument, final Float Left, final Float Top, final Float Width, final Float Height, final MsoPictureCompress Compress) throws ComException;
}
