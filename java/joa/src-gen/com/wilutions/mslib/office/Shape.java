...
public interface Shape extends IDispatch {
  ...
  @DeclDISPID(13)  public void Flip(final MsoFlipCmd FlipCmd) throws ComException;
  ...
  @DeclDISPID(19)  public void ScaleHeight(final Float Factor, final MsoTriState RelativeToOriginalSize, final MsoScaleFrom fScale) throws ComException;
  @DeclDISPID(20)  public void ScaleWidth(final Float Factor, final MsoTriState RelativeToOriginalSize, final MsoScaleFrom fScale) throws ComException;
  ...
  @DeclDISPID(24)  public void ZOrder(final MsoZOrderCmd ZOrderCmd) throws ComException;
  ...
  @DeclDISPID(157)  public void ConvertTextToSmartArt(final SmartArtLayout Layout) throws ComException;
