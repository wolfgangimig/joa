...
public class ContentVerificationResults implements ComEnum {
  ...
  public String toString() {
    ...
    default: {
      ...
      if ((value & 0) != 0) sbuf.append("|contverresError");
      if ((value & 1) != 0) sbuf.append("|contverresVerifying");
      if ((value & 2) != 0) sbuf.append("|contverresUnverified");
      if ((value & 3) != 0) sbuf.append("|contverresValid");
      if ((value & 4) != 0) sbuf.append("|contverresModified");
