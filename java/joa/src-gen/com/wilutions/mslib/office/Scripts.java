...
public interface Scripts extends IDispatch {
  ...
  @DeclDISPID(1610809348)  public Script Add(Dispatch Anchor, MsoScriptLocation Location, MsoScriptLanguage Language, String Id, String Extended, String ScriptText) throws ComException;
