...
public interface Permission extends IDispatch {
  ...
  @DeclDISPID(0)  public UserPermission getItem(final Object Index) throws ComException;
  ...
  @DeclDISPID(3)  public UserPermission Add(final String UserId, final Object Permission, final Object ExpirationDate) throws ComException;
