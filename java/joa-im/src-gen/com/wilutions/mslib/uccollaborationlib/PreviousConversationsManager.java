...
public class PreviousConversationsManager extends Dispatch implements IPreviousConversationsManager {
  ...
  @DeclDISPID(1610743816)  public IAsynchronousOperation GetUnreadItems(final Object _previousConversationsManagerCallback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743817)  public IAsynchronousOperation GetAllItems(final Object _previousConversationsManagerCallback, final Object _state) throws ComException {
    assert(_previousConversationsManagerCallback != null);
    assert(_state != null);
