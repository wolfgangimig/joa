 ...
 * UnreadMessageCountChangedEventData Class 
 */
...
public class UnreadMessageCountChangedEventData extends Dispatch {
  ...
  protected UnreadMessageCountChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[UnreadMessageCountChangedEventData" + super.toString() + "]";
  }
}
