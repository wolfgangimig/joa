 ...
 * ConversationWindowNeedsAttentionEventData Class 
 */
...
public class ConversationWindowNeedsAttentionEventData extends Dispatch {
  ...
  protected ConversationWindowNeedsAttentionEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ConversationWindowNeedsAttentionEventData" + super.toString() + "]";
  }
}
