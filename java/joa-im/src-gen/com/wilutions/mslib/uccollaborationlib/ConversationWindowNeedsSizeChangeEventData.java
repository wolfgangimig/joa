 ...
 * ConversationWindowNeedsSizeChangeEventData Class 
 */
...
public class ConversationWindowNeedsSizeChangeEventData extends Dispatch {
  ...
  protected ConversationWindowNeedsSizeChangeEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ConversationWindowNeedsSizeChangeEventData" + super.toString() + "]";
  }
}
