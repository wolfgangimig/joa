...
public class IVideoViewInformationDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IVideoViewInformationDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(final com.wilutions.mslib.uccollaborationlib.VideoViewInformationType _key) throws ComException {
    assert(_key != null);
  ...
  @DeclDISPID(1610743812)  public Boolean TryGetValue(final com.wilutions.mslib.uccollaborationlib.VideoViewInformationType _key, final ByRef<Object> _itemValue) throws ComException {
    assert(_key != null);
  ...
  @DeclDISPID(1610743813)  public com.wilutions.mslib.uccollaborationlib.VideoViewInformationType GetKeyAt(final Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743815)  public Boolean ContainsKey(final com.wilutions.mslib.uccollaborationlib.VideoViewInformationType _key) throws ComException {
    assert(_key != null);
