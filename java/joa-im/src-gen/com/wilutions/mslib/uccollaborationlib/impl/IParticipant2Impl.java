...
public class IParticipant2Impl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IParticipant2 {
  @DeclDISPID(268435457)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation PinVideo(Object _callback, Object _state) throws ComException {
  ...
  @DeclDISPID(268435458)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation UnPinVideo(Object _callback, Object _state) throws ComException {
    assert(_callback != null);
    assert(_state != null);
  ...
  @DeclDISPID(268435459)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation LockVideo(Object _callback, Object _state) throws ComException {
    assert(_callback != null);
    assert(_state != null);
  ...
  @DeclDISPID(268435460)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation UnLockVideo(Object _callback, Object _state) throws ComException {
    assert(_callback != null);
    assert(_state != null);
