...
public class IRoomMessageDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IRoomMessageDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(com.wilutions.mslib.uccollaborationlib.RoomMessageFormat _key) throws ComException {
    assert(_key != null);
    final Object obj = this._dispatchCall(0,"Item", DISPATCH_PROPERTYGET,null,_key.value);
    if (obj == null) return null;
    return (Object)obj;
  }
  @DeclDISPID(0)  public void setItem(com.wilutions.mslib.uccollaborationlib.RoomMessageFormat _key, Object value2) throws ComException {
    assert(value2 != null);
    assert(_key != null);
    this._dispatchCall(0,"Item", DISPATCH_PROPERTYPUT,value2,_key.value);
  }
  @DeclDISPID(1610743811)  public void Add(com.wilutions.mslib.uccollaborationlib.RoomMessageFormat _key, Object _value) throws ComException {
    assert(_key != null);
    assert(_value != null);
  ...
  @DeclDISPID(1610743814)  public Boolean TryGetValue(com.wilutions.mslib.uccollaborationlib.RoomMessageFormat _key, ByRef<Object> _itemValue) throws ComException {
    assert(_key != null);
  ...
  @DeclDISPID(1610743815)  public com.wilutions.mslib.uccollaborationlib.RoomMessageFormat GetKeyAt(Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743817)  public Boolean ContainsKey(com.wilutions.mslib.uccollaborationlib.RoomMessageFormat _key) throws ComException {
    assert(_key != null);
  ...
  @DeclDISPID(1610743819)  public void Remove(com.wilutions.mslib.uccollaborationlib.RoomMessageFormat _key) throws ComException {
    assert(_key != null);
  ...
  @DeclDISPID(1610743821)  public void setType(com.wilutions.mslib.uccollaborationlib.RoomMessageType value) throws ComException {
    assert(value != null);
