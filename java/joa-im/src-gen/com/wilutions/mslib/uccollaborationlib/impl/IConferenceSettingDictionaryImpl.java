...
public class IConferenceSettingDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IConferenceSettingDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(final com.wilutions.mslib.uccollaborationlib.ConferenceSetting _key) throws ComException {
    assert(_key != null);
    final Object obj = this._dispatchCall(0,"Item", DISPATCH_PROPERTYGET,null,_key.value);
    if (obj == null) return null;
    return (Object)obj;
  }
  @DeclDISPID(0)  public void setItem(final com.wilutions.mslib.uccollaborationlib.ConferenceSetting _key, final Object value2) throws ComException {
    assert(value2 != null);
    assert(_key != null);
    this._dispatchCall(0,"Item", DISPATCH_PROPERTYPUT,value2,_key.value);
  }
  @DeclDISPID(1610743811)  public void Add(final com.wilutions.mslib.uccollaborationlib.ConferenceSetting _key, final Object _value) throws ComException {
    assert(_key != null);
    assert(_value != null);
  ...
  @DeclDISPID(1610743814)  public Boolean TryGetValue(final com.wilutions.mslib.uccollaborationlib.ConferenceSetting _key, final ByRef<Object> _value) throws ComException {
    assert(_key != null);
    assert(_value != null);
  ...
  @DeclDISPID(1610743815)  public com.wilutions.mslib.uccollaborationlib.ConferenceSetting GetKeyAt(final Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743817)  public Boolean ContainsKey(final com.wilutions.mslib.uccollaborationlib.ConferenceSetting _key) throws ComException {
    assert(_key != null);
  ...
  @DeclDISPID(1610743819)  public void Remove(final com.wilutions.mslib.uccollaborationlib.ConferenceSetting _key) throws ComException {
    assert(_key != null);
