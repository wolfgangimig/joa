...
public class IConversationPropertyDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IConversationPropertyDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(final com.wilutions.mslib.uccollaborationlib.ConversationProperty _propertyType) throws ComException {
  ...
  @DeclDISPID(1610743812)  public Boolean TryGetValue(final com.wilutions.mslib.uccollaborationlib.ConversationProperty _propertyType, final ByRef<Object> _itemValue) throws ComException {
    assert(_propertyType != null);
  ...
  @DeclDISPID(1610743813)  public com.wilutions.mslib.uccollaborationlib.ConversationProperty GetKeyAt(final Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743815)  public Boolean ContainsKey(final com.wilutions.mslib.uccollaborationlib.ConversationProperty _propertyType) throws ComException {
    assert(_propertyType != null);
