...
public class _IContentSharingModalityEventsImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib._IContentSharingModalityEvents {
  ...
  @DeclDISPID(5080)  public void onOnContentAdded(com.wilutions.mslib.uccollaborationlib.IContentSharingModality _eventSource, com.wilutions.mslib.uccollaborationlib.IContentCollectionChangedEventData _eventData) throws ComException {
  ...
  @DeclDISPID(5081)  public void onOnContentRemoved(com.wilutions.mslib.uccollaborationlib.IContentSharingModality _eventSource, com.wilutions.mslib.uccollaborationlib.IContentCollectionChangedEventData _eventData) throws ComException {
  ...
  @DeclDISPID(5082)  public void onOnActivePresenterChanged(com.wilutions.mslib.uccollaborationlib.IContentSharingModality _eventSource, com.wilutions.mslib.uccollaborationlib.IActivePresenterChangedEventData _eventData) throws ComException {
  ...
  @DeclDISPID(5083)  public void onOnActiveContentChanged(com.wilutions.mslib.uccollaborationlib.IContentSharingModality _eventSource, com.wilutions.mslib.uccollaborationlib.IActiveContentChangedEventData _eventData) throws ComException {
