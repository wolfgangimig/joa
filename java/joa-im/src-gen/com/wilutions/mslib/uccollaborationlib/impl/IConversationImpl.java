...
public class IConversationImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IConversation {
  ...
  @DeclDISPID(1610743812)  public com.wilutions.mslib.uccollaborationlib.IParticipant AddParticipant(final IDispatch _contactOrCollaborationEndpoint) throws ComException {
  ...
  @DeclDISPID(1610743813)  public void RemoveParticipant(final com.wilutions.mslib.uccollaborationlib.IParticipant _participant) throws ComException {
  ...
  @DeclDISPID(1610743817)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation SetProperty(final com.wilutions.mslib.uccollaborationlib.ConversationProperty _propertyType, final Object _propertyValue, final Object _conversationCallback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743818)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation SendInitialContext(final com.wilutions.mslib.uccollaborationlib.ContextType[] _contextTypes, final Object[] _contextDatas, final Object _conversationCallback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743819)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation SendContextData(final String _applicationId, final String _dataType, final String _data, final Object _conversationCallback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743822)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation Merge(final com.wilutions.mslib.uccollaborationlib.IConversation _conversation, final com.wilutions.mslib.uccollaborationlib.ModalityTypes _modalityTypes, final Object _conversationCallback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743823)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation AdmitParticipants(final com.wilutions.mslib.uccollaborationlib.IParticipant[] _participants, final Object _conversationCallback, final Object _state) throws ComException {
  ...
  @DeclDISPID(1610743824)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation DenyParticipants(final com.wilutions.mslib.uccollaborationlib.IParticipant[] _participants, final Object _conversationCallback, final Object _state) throws ComException {
    assert(_participants != null);
    assert(_conversationCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610743825)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation Park(final Object _conversationCallback, final Object _state) throws ComException {
    assert(_conversationCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610743827)  public Boolean CanInvoke(final com.wilutions.mslib.uccollaborationlib.ConversationAction _action) throws ComException {
    assert(_action != null);
    final Object obj = this._dispatchCall(1610743827,"CanInvoke", DISPATCH_METHOD,null,_action.value);
    if (obj == null) return null;
    return (Boolean)obj;
  }
  @DeclDISPID(1610743828)  public Boolean CanSetProperty(final com.wilutions.mslib.uccollaborationlib.ConversationProperty _convProperty) throws ComException {
  ...
  @DeclDISPID(1610743830)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation MuteParticipants(final com.wilutions.mslib.uccollaborationlib.IParticipant[] _participants, final Object _conversationCallback, final Object _state) throws ComException {
    assert(_participants != null);
    assert(_conversationCallback != null);
    assert(_state != null);
  ...
  @DeclDISPID(1610743831)  public com.wilutions.mslib.uccollaborationlib.IAsynchronousOperation UnmuteParticipants(final com.wilutions.mslib.uccollaborationlib.IParticipant[] _participants, final Object _conversationCallback, final Object _state) throws ComException {
    assert(_participants != null);
    assert(_conversationCallback != null);
    assert(_state != null);
