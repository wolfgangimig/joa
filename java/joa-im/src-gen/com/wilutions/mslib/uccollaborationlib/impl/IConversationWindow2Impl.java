...
public class IConversationWindow2Impl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IConversationWindow2 {
  ...
  @DeclDISPID(268435460)  public void SetPreferredAnnotationTool(final com.wilutions.mslib.uccollaborationlib.AnnotationTool _annotationTool, final Integer _annotationColor) throws ComException {
  ...
  @DeclDISPID(268435467)  public Boolean CanInvoke(final com.wilutions.mslib.uccollaborationlib.ConversationWindowAction _action) throws ComException {
    assert(_action != null);
