...
public class _IChannelEventsImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib._IChannelEvents {
  @DeclDISPID(1300)  public void onOnStateChanged(com.wilutions.mslib.uccollaborationlib.IChannel _eventSource, com.wilutions.mslib.uccollaborationlib.IChannelStateChangedEventData _eventData) throws ComException {
  ...
  @DeclDISPID(1301)  public void onOnActionAvailabilityChanged(com.wilutions.mslib.uccollaborationlib.IChannel _eventSource, com.wilutions.mslib.uccollaborationlib.IChannelActionAvailabilityEventData _eventData) throws ComException {
