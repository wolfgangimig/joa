...
public class IParticipantPropertyDictionaryImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.IParticipantPropertyDictionary {
  ...
  @DeclDISPID(0)  public Object getItem(com.wilutions.mslib.uccollaborationlib.ParticipantProperty _propertyType) throws ComException {
  ...
  @DeclDISPID(1610743812)  public Boolean TryGetValue(com.wilutions.mslib.uccollaborationlib.ParticipantProperty _propertyType, ByRef<Object> _itemValue) throws ComException {
    assert(_propertyType != null);
  ...
  @DeclDISPID(1610743813)  public com.wilutions.mslib.uccollaborationlib.ParticipantProperty GetKeyAt(Integer _index) throws ComException {
    assert(_index != null);
  ...
  @DeclDISPID(1610743815)  public Boolean ContainsKey(com.wilutions.mslib.uccollaborationlib.ParticipantProperty _propertyType) throws ComException {
    assert(_propertyType != null);
