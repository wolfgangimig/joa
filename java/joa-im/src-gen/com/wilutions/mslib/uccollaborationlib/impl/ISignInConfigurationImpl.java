...
public class ISignInConfigurationImpl extends Dispatch implements com.wilutions.mslib.uccollaborationlib.ISignInConfiguration {
  @DeclDISPID(1610743808)  public Boolean CanSet(final com.wilutions.mslib.uccollaborationlib.SignInConfigurationType _configurationType) throws ComException {
  ...
  @DeclDISPID(1610743809)  public void setMode(final com.wilutions.mslib.uccollaborationlib.LyncClientConfigurationMode value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(1610743811)  public void setTransportMode(final com.wilutions.mslib.uccollaborationlib.TransportMode value) throws ComException {
    assert(value != null);
  ...
  @DeclDISPID(1610743822)  public void setSignInAsAvailability(final com.wilutions.mslib.uccollaborationlib.ContactAvailability value) throws ComException {
    assert(value != null);
