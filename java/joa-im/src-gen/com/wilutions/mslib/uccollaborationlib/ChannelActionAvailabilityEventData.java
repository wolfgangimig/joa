 ...
 * ChannelActionAvailabilityEventData Class 
 */
...
public class ChannelActionAvailabilityEventData extends Dispatch {
  ...
  protected ChannelActionAvailabilityEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ChannelActionAvailabilityEventData" + super.toString() + "]";
  }
}
