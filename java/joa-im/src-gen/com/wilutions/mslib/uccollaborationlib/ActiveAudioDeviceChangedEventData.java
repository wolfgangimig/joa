...
/**
 * ActiveAudioDeviceChangedEventData.
 * ActiveAudioDeviceChangedEventData Class 
 */
...
public class ActiveAudioDeviceChangedEventData extends Dispatch {
  ...
  protected ActiveAudioDeviceChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ActiveAudioDeviceChangedEventData" + super.toString() + "]";
  }
}
