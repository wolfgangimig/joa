...
public class VideoWindow extends Dispatch implements IVideoWindow {
  ...
  public VideoWindow() throws ComException {
    super("{6C97F743-778B-460F-B14E-073290C4E7E4}", "{56A868B4-0AD4-11CE-B03A-0020AF0BA770}");
  }
  protected VideoWindow(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[VideoWindow" + super.toString() + "]";
  }
}
