 ...
 * ConversationWindowStateChangedEventData Class 
 */
...
public class ConversationWindowStateChangedEventData extends Dispatch {
  ...
  protected ConversationWindowStateChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ConversationWindowStateChangedEventData" + super.toString() + "]";
  }
}
