 ...
 * ParticipantPropertyChangedEventData Class 
 */
...
public class ParticipantPropertyChangedEventData extends Dispatch {
  ...
  protected ParticipantPropertyChangedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ParticipantPropertyChangedEventData" + super.toString() + "]";
  }
}
