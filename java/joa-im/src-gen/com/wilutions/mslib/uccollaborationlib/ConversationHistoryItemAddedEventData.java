 ...
 * ConversationHistoryItemAddedEventData Class 
 */
...
public class ConversationHistoryItemAddedEventData extends Dispatch {
  ...
  protected ConversationHistoryItemAddedEventData(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[ConversationHistoryItemAddedEventData" + super.toString() + "]";
  }
}
