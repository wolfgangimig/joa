...
@CoClass(guid="{159BAAED-ABEA-93B9-2FAA-5FE3C76A12EA}")
public class IMessenger3Impl extends Dispatch implements com.wilutions.mslib.messengerapi.IMessenger3 {
  ...
  public IMessenger3Impl(String progId) throws ComException {
    super(progId, "{D50C3386-0F89-48F8-B204-3604629DEE10}");
  }
  protected IMessenger3Impl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[IMessenger3Impl" + super.toString() + "]";
  }
}
