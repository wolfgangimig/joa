...
@CoClass(guid="{159BADED-ABEA-93B9-2FAA-5FE3C76A12EA}")
public class IMessenger4Impl extends Dispatch implements com.wilutions.mslib.messengerapi.IMessenger4 {
  ...
  @DeclDISPID(1314)  public Object getProperty(final com.wilutions.mslib.messengerapi.MMESSENGERPROPERTY ePropType) throws ComException {
    assert(ePropType != null);
    final Object obj = this._dispatchCall(1314,"Property", DISPATCH_PROPERTYGET,null,ePropType.value);
    if (obj == null) return null;
    return (Object)obj;
  }
  @DeclDISPID(1314)  public void setProperty(final com.wilutions.mslib.messengerapi.MMESSENGERPROPERTY ePropType, final Object value2) throws ComException {
    assert(value2 != null);
    assert(ePropType != null);
  ...
  public IMessenger4Impl(String progId) throws ComException {
    super(progId, "{D50C3486-0F89-48F8-B204-3604629DEE10}");
  }
  protected IMessenger4Impl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[IMessenger4Impl" + super.toString() + "]";
  }
}
