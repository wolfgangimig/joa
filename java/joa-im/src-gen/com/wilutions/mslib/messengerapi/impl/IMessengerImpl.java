...
@CoClass(guid="{159BA8ED-ABEA-93B9-2FAA-5FE3C76A12EA}")
public class IMessengerImpl extends Dispatch implements com.wilutions.mslib.messengerapi.IMessenger {
  ...
  public IMessengerImpl(String progId) throws ComException {
    super(progId, "{D50C3186-0F89-48F8-B204-3604629DEE10}");
  }
  protected IMessengerImpl(long ndisp) {
    super(ndisp);
  }
  public String toString() {
    return "[IMessengerImpl" + super.toString() + "]";
  }
}
